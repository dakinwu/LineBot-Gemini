...
NOTION_PARENT_PAGE_MORNING = (
    os.getenv("NOTION_PARENT_PAGE_MORNING_URL")
...
NOTION_PARENT_PAGE_AFTER_HOURS = (
    os.getenv("NOTION_PARENT_PAGE_AFTER_HOURS_URL")
    or os.getenv("NOTION_PARENT_PAGE_MORNING_URL")
    or os.getenv("NOTION_PARENT_PAGE_URL")
    or os.getenv("NOTION_PARENT_PAGE_ID")
    or "https://www.notion.so/1ecb98676e4e806d8480eaefa758945f"
)
